...
#define MANAK_BENCHMARK_CASE_IS(Name, Library, Function, Iter, SP)            \
...
#define MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_TIS(Name, Lib, Fun, Tol, Iter, SP) \
_MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_TIS(Name, Lib, Fun, Tol, Iter, SP)

#define MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_TI(Name, Lib, Fun, Tol, Iter)    \
MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_TIS(Name, Lib, Fun, Tol, Iter, MANAK_DEFAULT_SP)

#define MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_IS(Name, Lib, Fun, Iter, SP)     \
MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_TIS(Name, Lib, Fun, MANAK_DEFAULT_TOLERANCE, Iter, SP)

#define MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_T(Name, Lib, Fun, Tol)           \
MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_TI(Name, Lib, Fun, Tol, MANAK_DEFAULT_ITERATIONS)

#define MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_I(Name, Lib, Fun, Iter)          \
MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE_TI(Name, Lib, Fun, MANAK_DEFAULT_TOLERANCE, Iter)

#define MANAK_CREATE_GROUP_BENCHMARK_WITH_TEMPLATE(Name, Lib, Fun)                  \
